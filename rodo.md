# 🌿 Klauzula Informacyjna RODO — Florium
...
1. [Tożsamość i dane kontaktowe Administratora](#i-tożsamość-i-dane-kontaktowe-administratora)
2. [Cele i podstawy prawne przetwarzania](#ii-cele-i-podstawy-prawne-przetwarzania)
3. [Kategorie przetwarzanych danych osobowych](#iii-kategorie-przetwarzanych-danych-osobowych)
4. [Odbiorcy danych i podmioty przetwarzające](#iv-odbiorcy-danych-i-podmioty-przetwarzające)
5. [Okresy retencji danych](#v-okresy-retencji-danych)
6. [Prawa osoby, której dane dotyczą](#vi-prawa-osoby-której-dane-dotyczą)
7. [Prawo wniesienia skargi do organu nadzorczego](#vii-prawo-wniesienia-skargi-do-organu-nadzorczego)
8. [Zautomatyzowane podejmowanie decyzji i profilowanie](#viii-zautomatyzowane-podejmowanie-decyzji-i-profilowanie)
9. [Źródło danych](#ix-źródło-danych)
10. [Dobrowolność podania danych](#x-dobrowolność-podania-danych)
11. [Zmiany klauzuli informacyjnej](#xi-zmiany-klauzuli-informacyjnej)
...
Administrator **nie wyznaczył** Inspektora Ochrony Danych (IOD), gdyż nie jest do tego zobligowany na podstawie art. 37 RODO — brak przetwarzania danych na dużą skalę ani szczególnych kategorii danych jako działalności głównej.

Wszelkie zapytania w sprawach ochrony danych kieruj na adres: [babiuchdesign@gmail.com](mailto:babiuchdesign@gmail.com).
...
|---|---|
| Rejestracja i obsługa konta (logowanie e-mail, SSO) | art. 6 ust. 1 lit. b RODO – niezbędność do wykonania umowy |
...
| Obsługa płatności, odblokowanie limitów i subskrypcji Premium | art. 6 ust. 1 lit. b RODO – wykonanie umowy zakupu |
...
- **Dane identyfikacyjne:** adres e-mail, bezpiecznie szyfrowane hasło (w przypadku logowania e-mail), imię (opcjonalnie), unikalny identyfikator konta (UID SSO).
...
| **RevenueCat Inc.** | Zarządzanie subskrypcjami (in-app purchases) | USA | SCC (decyzja KE 2021/914) + EU-US DPF (decyzja KE 2023/1795) |
| **Dostawca usług AI** (OpenAI / Google Cloud Vision) | Analiza gatunkowa zdjęć | USA | SCC (decyzja KE 2021/914) + EU-US DPF (decyzja KE 2023/1795) |
...
|---|---|
| Dane konta, kolekcja roślin, zdjęcia | Przez cały okres aktywności konta. Usunięcie konta z poziomu aplikacji = **natychmiastowe, nieodwracalne** usunięcie z serwerów |
...
Możesz skorzystać z poniższych praw, kontaktując się pod adresem [babiuchdesign@gmail.com](mailto:babiuchdesign@gmail.com) lub bezpośrednio przez ustawienia Aplikacji.

> Administrator odpowie bez zbędnej zwłoki, nie później niż w ciągu **30 dni** (art. 12 ust. 3 RODO). W przypadku złożonych wniosków termin może zostać przedłużony o kolejne 60 dni, o czym Administrator poinformuje w terminie pierwszych 30 dni.
...
Możesz natychmiastowo usunąć konto w *Ustawienia → Profil → Usuń konto*. Skutek jest natychmiastowy i nieodwracalny.
...
- 📷 **Kamera/galeria:** Ustawienia systemu → Aplikacje → Florium → Uprawnienia
- 📍 **Lokalizacja GPS:** Ustawienia systemu → Prywatność → Lokalizacja
- 🔔 **Powiadomienia:** Ustawienia systemu → Powiadomienia → Florium
...
> E-mail: [kancelaria@uodo.gov.pl](mailto:kancelaria@uodo.gov.pl)
...
Wszystkie dane osobowe zbierane przez Aplikację pochodzą **bezpośrednio od Użytkownika** — są przekazywane podczas rejestracji, korzystania z funkcji skanera, oznaczania lokalizacji roślin lub w wyniku logowania przez serwisy Google / Apple.

Administrator nie pozyskuje danych osobowych z innych zewnętrznych źródeł.
...
| Dane | Dobrowolność |
|---|---|
| Adres e-mail, hasło, UID SSO | **Wymagane** — warunek konieczny do założenia konta |
| Lokalizacja GPS, dane EXIF | **Opcjonalne** — brak zgody nie uniemożliwia korzystania z aparatu ani skanera roślin |
